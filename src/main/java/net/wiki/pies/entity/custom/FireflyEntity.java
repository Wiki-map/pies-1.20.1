package net.wiki.pies.entity.custom;
...
public class FireflyEntity extends AnimalEntity {
    ...
    public static DefaultAttributeContainer.Builder createFireflyAttributes() {
        return MobEntity.createMobAttributes().add(EntityAttributes.GENERIC_MAX_HEALTH, 10).add(EntityAttributes.GENERIC_MOVEMENT_SPEED,0.5);
    }
